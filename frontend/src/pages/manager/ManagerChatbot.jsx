                ...
                <div className="flex-1 overflow-y-auto p-4 space-y-4">
                    {messages.map((msg, index) => (
                        ...
                        >
                            ...
                            <div className={`max-w-[80%] p-4 rounded-2xl text-sm leading-relaxed whitespace-pre-wrap ${msg.role === 'user' ? 'bg-blue-600 text-white rounded-tr-none' : 'bg-slate-100 text-slate-800 rounded-tl-none'}`}>
                                {msg.content}
                            </div>
                        </div>
                    ))}
                ...
                <form onSubmit={handleSubmit} className="p-4 border-t border-slate-100 bg-white">
                    ...
                    <div className="flex items-center gap-2">
                        ...
                        <button
                            ...
                            disabled={isLoading || isTranscribing}
                            className={`p-3 rounded-lg transition-all disabled:opacity-50 disabled:cursor-not-allowed ${isRecording ? 'bg-red-500 text-white hover:bg-red-600 animate-pulse' : 'bg-slate-100 text-slate-600 hover:bg-slate-200'}`}
                        >
